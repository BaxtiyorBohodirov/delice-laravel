            ...
            <div class="header header-h">
                                ...
                                <div class="header-top-search">
                                    <div class="search-modal" style="display: none">
                                        <form class="search-modal-form">
                                            <input type="text" class="search-modal-input" placeholder="поиск по сайту">
                ...
                <div class="header-slider">
                        @foreach($carousels as $item)
                            <div class="slider" style="background: url('{{Voyager::image($item->image)}}') no-repeat">
                                <div class="slider-info">
                                    <h2 class="slider-title wow fadeInRight" data-wow-duration="2s">{{$item->title()}}</h2>
                                    <div class="slider-devider"></div>
                                    <p class="slider-text">
                                        <?=$item->content()?>
                                    </p>
                                    <div class="slider-button">
                                        <button class="slider-button-first wow fadeInRight">Подробнее</button>
                                        <button class="slider-button-two wow fadeInRight">Заказать</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
