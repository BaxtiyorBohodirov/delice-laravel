...
<div class="container">
    <div class="de-slider">
        <div class="de-slider-main">
            <img id="featured" src="{{Voyager::image($productImages[0]->image)}}" alt="">
        </div>
...
for($i=1;$i<count($productImages);$i++):?>
                    <div class="de-slider-item-img">
                        <img class="thumbnail" src="{{Voyager::image($productImages[$i]->image)}}" alt="">
                    </div>
                <?php endfor?>
    ...
    <div class="de-about-info-item de-gallery-info">
        <h4 class="de-about-info-title">{{ProductsCatalog::find($product->catalog_id)->title()}}</h4>
