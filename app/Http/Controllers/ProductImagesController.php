...
class ProductImagesController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->image)
        {
            $model_name=app($dataType->model_name);
            $oldImage="storage/".$model_name->find(['id'=>$id])->first()->image;
            if(file_exists($oldImage))
            {
                Storage::delete("public/".$model_name->find(['id'=>$id])->first()->image);
            }
        }
